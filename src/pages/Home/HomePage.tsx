...
import { BookOpen, CreditCard, Share2, Shield, Users, Video } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2" alt="User" className="w-16 h-16 rounded-full mx-auto mb-4" />
              <p className="text-lg text-text-secondary mb-4">"The step-by-step guides made learning email so easy!"</p>
              <h3 className="text-xl font-bold text-text-primary">Mary Johnson</h3>
            </div>
